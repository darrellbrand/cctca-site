        ...
        <section id="instructors" className="w-full bg-slate-200 px-6 md:px-12 lg:px-24 electrolize-regular">
            <div className="max-w-5xl mx-auto text-center mb-10">
                ...
                <p className="text-gray-700 text-lg leading-relaxed">
                    ...
                    They are dedicated to helping learners build skills, confidence, and self-sufficiency as part of CCTCA’s broader charitable mission.
                </p>
            </div>
                    ...
                    <CardContent className="p-6">
                        ...
                        <div className='flex flex-col gap-2'>
                            <p className="text-gray-700">
                                ...
                                He specializes in making digital tools approachable for learners of all backgrounds, integrating real-world examples into lessons that 
                                support everyday life, personal projects, and continued education.
                            </p>
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">Cybersecurity & Technology Instructor</p>
                            </div>
                        </div>
                        <div className='flex flex-col gap-2'>
                            <p className="text-gray-700">
                                Jonathan has a background in IT support and digital safety education. 
                                He guides learners through foundational cybersecurity practices, practical troubleshooting, and community-based tech projects. 
                                For those who wish to pursue external certifications or advanced study, Jonathan offers general learning support and encouragement, 
                                while keeping CCTCA’s focus on skill-building and digital empowerment.
                            </p>
                            <div className="flex items-center space-x-3">
                                <Mail className="w-5 h-5 text-blue-700 group-hover:text-blue-900 transition-colors duration-300" />
