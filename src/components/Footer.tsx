        ...
        <footer className="bg-slate-100 -mt-1  text-gray-700  electrolize-regular">
            <div className="max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <p >
                       Central Coast Tech & Career Academy (CCTCA) is a California nonprofit public benefit corporation recognized as a 501(c)(3) charitable organization.
The use of the word “Academy” in our name reflects our community-based learning model and does not indicate operation as a state-licensed postsecondary educational institution.
CCTCA is not licensed by the California Bureau for Private Postsecondary Education and operates under the exemption set forth in California Education Code §94874(f).
Our instructional programs are non-degree, offered at total charges not exceeding $2,500 per student in any 12-month period, and we do not accept state or federal student financial aid.
                    </p>
                </div>
            </div>
        </footer>
